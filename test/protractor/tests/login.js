...
describe('Login Component', () => {
  ...
  it('should toggle password visibility when the Show button is clicked', () => {
    ...
    expect(loginComponent.isPasswordFieldPlaintext()).to.be.false;

    console.log(loginComponent.togglePasswordButton().getText());

    expect(loginComponent.clickTogglePasswordButton()).to.be.fulfilled;
    expect(loginComponent.isPasswordFieldPlaintext()).to.be.true;
